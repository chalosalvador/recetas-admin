...
import {ABOUT, ADDCHEFS, CHEFSLIST, ADDRECIPIES, RECIPESLIST } from '../constants/routes';
      ...
      this.props.isAuthenticated
        ...
        >
          ...
          <SubMenu key='sub1' title={ <span><SolutionOutlined /><span>Gestion Usuarios</span></span> }>
            ...
            <Menu.Item key='3'>
            <Link to={ CHEFSLIST }>Lista de Chefs</Link></Menu.Item>
          </SubMenu>

          <SubMenu key='sub2' title={ <span><SnippetsOutlined /><span>Gestion Recetas</span></span> }>
            <Menu.Item key='4'><Link to={ ADDRECIPIES }>Registrar Recetas</Link></Menu.Item>
            <Menu.Item key='5'><Link to={ RECIPESLIST }>Lista de Recetas</Link></Menu.Item>
